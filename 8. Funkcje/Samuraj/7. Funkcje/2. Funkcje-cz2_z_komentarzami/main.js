...
// ARGUMENTS — być może nie będziesz tak często używała, ale wiedz, że jest coś takiego jak obiekt arguments
// (podobny do tablicy, ale to nie jest tablica), który zawiera aktualną listę argumentów przekazanych do tablicy.
...
const showArguments = function () {
  ...
  console.log(typeof arguments); // Obiekt (tablicopodobny). Ma właściwość length, można odwołać się za pomocą notacji
                                 // tablicowej np. arguments [2]. Nie ma metod znanych z tablicy
...
// showInfoAboutUser(25, 'Adam', 'mężczyzna', null);
