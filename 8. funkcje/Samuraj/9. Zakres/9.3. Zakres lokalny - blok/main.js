...

{
  ...
  //  console.log(var2);
  //  console.log(var3);
  //  var1 = "wewnętrzne 1 bis";
  //  var2 = "wewnętrzne 2";
  var3 = "wewnętrzne 3 bis";
  const var4 = "coś"
}
// console.log(var1);
// console.log(var2);
...
// Zakres to lista wszystkich zadeklarowanych identyfikatorów (zmienne) możliwych do użycia w danym momencie
...
// W naszym programie (złożonym) istnieje mnóstwo zakresów. Każdy blok, funkcja, tworzy swój zakres. Jeden zakres
// może być zagnieżdżony w innym zakresie.

//Zakres jest zależny od tego, gdzie dana zmienna znajduje się w kodzie (gdzie została utworzona).

// Zasady szukania zmiennej:
//  — najpierw zakres, w którym jesteśmy. Póki nie znajdzie, przeszukuje do zakresu najwyższego (zakres globalny)
// — Po znalezieniu (dopasowaniu) pierwszej pasującej zmiennej pozostałe nie są już szukane.
